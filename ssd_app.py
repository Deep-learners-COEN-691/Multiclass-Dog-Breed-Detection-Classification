# ============================================================
# Streamlit Demo App for Stanford Dogs SSD
# ------------------------------------------------------------
# This app provides a lightweight interactive interface
# to test the trained SSD dog-breed detector.
#
...
#   - Confidence scores
#
# The demo uses the trained SSD model.
# ============================================================
...
MODEL_PATH = "ssd_dogs.pth"    # <-- your trained model path
